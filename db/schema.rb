...
ActiveRecord::Schema[7.0].define(version: 2024_01_04_202059) do
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.index ["reactionable_id", "reactionable_type", "user_id"], name: "index_reactions_on_reactionable_and_user_id", unique: true
