...
ActiveRecord::Schema[7.0].define(version: 2023_12_20_235924) do
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.index ["reactionable_id", "user_id"], name: "index_reactions_on_reactionable_id_and_user_id", unique: true
